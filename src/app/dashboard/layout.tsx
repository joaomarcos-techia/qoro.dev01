...
const navConfig: Record<string, NavGroup> = {
    ...
    // The pulse module now has its own dedicated layout,
    // so it's removed from the main nav config to avoid nested sidebars.
};
...
export default function DashboardLayout({ 
  ...
  // If the current module is 'pulse', this layout will not render the sidebar,
  // as the Pulse module has its own dedicated layout.
  // We check for module existence in navConfig.
  const shouldRenderSidebar = currentModule !== 'home' && navConfig[currentModule];
