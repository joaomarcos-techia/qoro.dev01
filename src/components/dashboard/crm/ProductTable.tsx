  ...
  if (data.length === 0) {
    return (
        <div className="flex flex-col items-center justify-center text-center min-h-[400px]">
            ...
            <h3 className="text-xl font-bold text-black">Nenhum produto cadastrado</h3>
            <p className="text-gray-500 mt-2">Comece adicionando seu primeiro produto para vê-lo aqui.</p>
        </div>
    )
  }
  ...
  return (
    <div>
       <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-black">Sua Lista de Produtos</h2>
