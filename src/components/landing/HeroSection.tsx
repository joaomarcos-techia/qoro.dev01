      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-white/70 mb-10 max-w-4xl mx-auto leading-relaxed">
           A Growth IA Transforma Processos em um Motor de Lucro Autônomo. O Fim da Fricção Humana. Enquanto sua equipe se afoga em tarefas repetitivas e leads que esfriam, a IA Agentica opera 24/7, qualificando, atendendo e fidelizando com precisão cirúrgica. Você está perdendo escala a cada minuto que seu negócio não é Agentic.
          </p>
